...
describe MiniTest::Spec do
  ...
  it 'should also work with strings' do
    ...
    @matching_json_string.must_match_json @pattern
    assert_raises(::MiniTest::Assertion) { @non_matching_json.must_match_json @pattern }

    @non_matching_json_string.wont_match_json @pattern
    assert_raises(::MiniTest::Assertion) { @matching_json.wont_match_json @pattern }
  end
end
